<?php
                ...
                $query = "SELECT * FROM user_posts WHERE user_id = {$user_id} AND status = 'approved' ORDER BY post_id DESC";
                ...
                while ($row = mysqli_fetch_assoc($post_query)) {
                    ...
                    if (!empty($row['media_url'])) {
                        echo '<img src="./includes/images/' . htmlspecialchars($row['media_url']) . '" alt="user post image"><br>';
                    }
